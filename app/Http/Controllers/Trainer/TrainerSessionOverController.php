...
class TrainerSessionOverController extends Controller
{
    public function index(Request $request)
    {
        $trainerSessions = DB::table('trainer_sessions as a')
            ...
            ->groupBy('a.id', 'a.start_date', 'a.description', 'a.package_price', 'a.admin_price', 'b.full_name', 'b.member_code', 'c.package_name', 'c.number_of_session', 'd.full_name', 'e.full_name', 'e.check_in_count')
