@foreach ($members as $member => $item)
    <div class="modal fade bd-example-modal-lg-detail{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="full_name"
                                        ...
                                        id="exampleFormControlInput1" autocomplete="off" disabled>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="mb-3">
                            ...
                            <div class="col-xl-6" id="born">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="born" value="{{ old('born', $item->born) }}"
                                        class="form-control" placeholder="Choose born date" id="mdate" disabled>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="mb-3">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="6"
                                        placeholder="Enter Address" disabled>{{ old('address', $item->address) }}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="mb-3">
