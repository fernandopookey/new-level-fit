<!-- Modal Edit -->
@foreach ($transferPackage as $item => $value)
    <div class="modal fade" id="modalEdit{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                <form action="{{ route('transfer-package.update', $value->id) }}" method="POST"
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="package_type"
                                        value="{{ old('package_type', $value->package_type) }}" class="form-control"
                                        id="exampleFormControlInput1" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-xl-6">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="staff_name"
                                        value="{{ old('staff_name', $value->staff_name) }}" class="form-control"
                                        id="exampleFormControlInput1" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-xl-6">
