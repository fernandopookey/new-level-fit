<!-- Modal Edit -->
@foreach ($lockerPackage as $item => $value)
    <div class="modal fade" id="modalEdit{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                <form action="{{ route('locker-package.update', $value->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Locker Package</h1>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="number_of_days"
                                        value="{{ old('number_of_days', $value->number_of_days) }}" class="form-control"
                                        id="exampleFormControlInput1" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-xl-6">
