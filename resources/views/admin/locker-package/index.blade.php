                        ...
                        <tbody>
                            @foreach ($lockerPackage as $item)
                                <tr>
                                    ...
                                    <td>{{ formatRupiah($item->package_price) }}</td>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <form action="{{ route('locker-package.destroy', $item->id) }}"
...
@include('admin.locker-package.create')
@include('admin.locker-package.edit')
