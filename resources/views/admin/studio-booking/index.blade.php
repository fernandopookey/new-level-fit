                ...
                <div class="page-title flex-wrap">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal"
                            data-bs-target="#modalAdd"> + New Studio Booking</button>
                    </div>
                </div>
            </div>
            <!--column-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <form action="{{ route('studio-booking.destroy', $item->id) }}"
...
@include('admin.studio-booking.create')
@include('admin.studio-booking.edit')
