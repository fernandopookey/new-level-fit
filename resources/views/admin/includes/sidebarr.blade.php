            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">PT</a>
                        <ul aria-expanded="false">
                            <li style="margin-left: 10px"><a href="{{ route('pt-total-report') }}">PT Total</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li style="margin-left: 10px">
                                ...
                                <ul aria-expanded="false">
                                    <li style="margin-left: 10px"><a href="{{ route('cs-total-report-member-checkin') }}">Total</a></li>
                                    <li style="margin-left: 10px"><a href="{{ route('cs-detail-report-member-checkin') }}">Detail</a></li>
                                </ul>
                            </li>
                            <li style="margin-left: 10px">
                                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">PT</a>
                                <ul aria-expanded="false">
                                    <li style="margin-left: 10px"><a href="{{ route('cs-total-report-pt') }}">Total</a></li>
                                    <li style="margin-left: 10px"><a href="{{ route('cs-detail-report-pt') }}">Detail</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
