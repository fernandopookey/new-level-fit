<!-- Modal Add -->
<div class="modal fade" id="modalAddPhysiotherapy" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
        <div class="modal-content">
            <form action="{{ route('physiotherapy.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Create Physiotherapy</h1>
...
<!-- Modal Edit -->
@foreach ($physiotherapy as $item)
    <div class="modal fade" id="modalEditPhysiotherapy{{ $item->id }}" tabindex="-1"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                <form action="{{ route('physiotherapy.update', $item->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Physiotherapy</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        @if ($errors->any())
                    ...
                    <div class="page-title flex-wrap">
                        ...
                        <div>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#modalAddPhysiotherapy">
                                + New Physiotherapy
                            </button>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div>
                                                <button type="button" class="btn light btn-warning btn-xs mb-1"
                                                    ...
                                                    data-bs-target="#modalEditPhysiotherapy{{ $item->id }}">
                                                    Edit
                                                </button>
                                                <form action="{{ route('physiotherapy.destroy', $item->id) }}"
