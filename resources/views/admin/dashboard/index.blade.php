...
@php
    $totalMemberRegistrationPrice = 0;
    $adminPriceMemberRegistration = 0;
@endphp
@foreach ($memberRegistrationTotalAmount as $item)
    @php
        $totalMemberRegistrationPrice += $item->total_price;
        $adminPriceMemberRegistration += $item->admin_price;
    @endphp
@endforeach

{{-- TRAINER SESSION TOTAL AMOUNT --}}
@php
    $totalTrainerSessionPrice = 0;
    $adminPriceTrainerSession = 0;
@endphp
@foreach ($trainerSessionTotalAmount as $item)
    @php
        $totalTrainerSessionPrice += $item->total_price;
        $adminPriceTrainerSession += $item->admin_price;
    @endphp
@endforeach
        ...
        <div class="card">
            <div class="card-body">
                <ul class="d-flex align-items-center">
                    ...
                    <li class="text-end">
                        <span><b>Member Registration Amount</b></span>
                        <h5 class="my-3">{{ formatRupiah($totalMemberRegistrationPrice) }}</h5>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <ul class="d-flex align-items-center">
                    ...
                    <li class="text-end">
                        <span><b>Trainer Session Amount</b></span>
                        <h5 class="my-3">{{ formatRupiah($totalTrainerSessionPrice) }}</h5>
                    </li>
                </ul>
            </div>
        </div>
